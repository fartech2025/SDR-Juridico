...
-- Políticas para usuários autenticados (acesso total por enquanto)
-- Você pode refinar essas políticas posteriormente para controle granular
Usuarios
...
-- Casos
CREATE POLICY "Usuários autenticados podem ver todos os casos"
  ON casos FOR SELECT
  TO authenticated
  USING (true);
...
-- Agenda
CREATE POLICY "Usuários autenticados podem ver todos os eventos da agenda"
  ON agenda FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Usuários autenticados podem inserir eventos na agenda"
  ON agenda FOR INSERT
  TO authenticated
  WITH CHECK (true);

CREATE POLICY "Usuários autenticados podem atualizar eventos da agenda"
  ON agenda FOR UPDATE
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Usuários autenticados podem deletar eventos da agenda"
  ON agenda FOR DELETE
  TO authenticated
  USING (true);

-- Timeline Events
CREATE POLICY "Usuários autenticados podem ver todos os eventos da timeline"
  ON timeline_events FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Usuários autenticados podem inserir eventos na timeline"
  ON timeline_events FOR INSERT
  TO authenticated
  WITH CHECK (true);

CREATE POLICY "Usuários autenticados podem atualizar eventos da timeline"
  ON timeline_events FOR UPDATE
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Usuários autenticados podem deletar eventos da timeline"
  ON timeline_events FOR DELETE
  TO authenticated
  USING (true);

-- Notificações
CREATE POLICY "Usuários autenticados podem ver todas as notificações"
...
CREATE POLICY "Usuários autenticados podem deletar notificações"

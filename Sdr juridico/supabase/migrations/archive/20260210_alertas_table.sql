...
DROP POLICY IF EXISTS "alertas_insert_org_member" ON public.alertas;
CREATE POLICY "alertas_insert_org_member"
  ON public.alertas
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "alertas_update_org_member" ON public.alertas;
CREATE POLICY "alertas_update_org_member"
  ON public.alertas
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "alertas_delete_org_admin" ON public.alertas;

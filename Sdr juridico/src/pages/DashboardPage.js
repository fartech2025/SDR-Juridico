...
const DashboardPage = () => {
  ...
  const anyLoading = leadsLoading || casosLoading || docsLoading || agendaLoading || notasLoading;
  ...
  const baseState = anyLoading && !loadTimeoutReached ? "loading" : anyError || loadTimeoutReached ? "error" : hasData ? "ready" : "empty";
  const pageState = status !== "ready" ? status : baseState;
  const errorMessage = loadTimeoutReached ? "Tempo limite ao carregar o painel. Tente novamente." : anyError?.message;
  const showRetry = Boolean(anyError || loadTimeoutReached);
  const leadHot = leads.find((lead) => lead.heat === "quente" && lead.status !== "ganho") ?? leads[0];
  ...
  const criticalEvents = React.useMemo(() => {
    ...
    return [...notas].filter((event) => caseIds.has(event.casoId)).sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 4);
  }, [casos, notas]);
  ...
  const kpis = React.useMemo(() => {
    ...
    const avgResponseHours = (() => {
      ...
      return Math.round(total / valid.length / (1e3 * 60 * 60));
    })();
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen pb-12 bg-base text-text", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute -right-10 -top-10 h-52 w-52 rounded-full bg-brand-primary/8 blur-3xl" }),
            /* @__PURE__ */ jsx("div", { className: "absolute -bottom-16 left-12 h-64 w-64 rounded-full bg-brand-secondary/8 blur-3xl" })
          ] }),
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[11px] uppercase tracking-[0.32em] text-text-muted", children: "Dashboard" }),
            /* @__PURE__ */ jsx("h2", { className: "font-display text-3xl text-text", children: "Resumo executivo" }),
            /* @__PURE__ */ jsx("p", { className: "max-w-2xl text-sm text-text-muted", children: "Foco em caso critico, produtividade e agenda juridica com uma vis\xE3o clara do funil." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxs(
      PageState,
      {
        ...
        onRetry: showRetry ? handleRetry : void 0,
        children: [
          /* @__PURE__ */ jsx("div", { className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-4", children: kpis.slice(0, 4).map((item) => /* @__PURE__ */ jsx(
            StatCard,
            {
              label: item.label,
              value: item.value,
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 xl:grid-cols-[2.2fr_1fr]", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
                /* @__PURE__ */ jsx(
                  ActionCard,
                  {
                    ...
                    description: leadHot ? `Contato pendente: ${leadHot.name} (${leadHot.area}).` : "Nenhum lead quente identificado.",
                    priority: "P0",
                ...
                /* @__PURE__ */ jsx(
                  ActionCard,
                  {
                    ...
                    description: docPending ? `${docPending.title} para ${docPending.cliente}.` : "Nenhum documento pendente.",
                    priority: "P1",
              ...
              /* @__PURE__ */ jsxs(
                Card,
                {
                  className: "border border-border bg-surface/90",
                  children: [
                    /* @__PURE__ */ jsxs(CardHeader, { className: "flex-row items-center justify-between space-y-0 px-6 pt-6 pb-2", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx(Flag, { className: "h-4 w-4 text-warning" }),
                        /* @__PURE__ */ jsx(CardTitle, { className: "text-sm", children: "Eventos criticos hoje" })
                      ] }),
                      criticalEvents[0]?.casoId && /* @__PURE__ */ jsxs(
                        Button,
                        {
                          variant: "ghost",
                          size: "sm",
                    ...
                    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 px-6 pb-6", children: [
                      criticalEvents.length === 0 && /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-border bg-white px-4 py-6 text-center text-xs text-text-muted shadow-[0_8px_20px_rgba(18,38,63,0.06)]", children: "Nenhum evento critico registrado hoje." }),
                      criticalEvents.map((event) => /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
                            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                              /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-text", children: event.title }),
                              /* @__PURE__ */ jsx("p", { className: "text-xs text-text-muted", children: event.description }),
                              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-text-subtle", children: [
                                /* @__PURE__ */ jsx(
                                  Badge,
                                  {
                            ...
                            /* @__PURE__ */ jsx("span", { className: "text-[10px] text-text-subtle", children: formatDateTime(event.date) })
                          ] })
                        },
                        event.id
                      ))
              ...
              /* @__PURE__ */ jsxs(
                Card,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs(CardHeader, { className: "flex-row items-center justify-between space-y-0 px-6 pt-6 pb-2", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx(CalendarDays, { className: "h-4 w-4 text-accent" }),
                        /* @__PURE__ */ jsx(CardTitle, { className: "text-sm", children: "Agenda do dia" })
                      ] }),
                      /* @__PURE__ */ jsx(
                        Link,
                        {
                    ...
                    /* @__PURE__ */ jsx(CardContent, { className: "space-y-3 px-6 pb-6", children: agendaToday.map((item) => /* @__PURE__ */ jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxs("div", { children: [
                            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-text", children: item.title }),
                            /* @__PURE__ */ jsxs("p", { className: "text-xs text-text-subtle", children: [
                              item.cliente,
                              " - ",
                              item.location
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { className: "text-right text-xs text-text-subtle", children: [
                            /* @__PURE__ */ jsx("div", { children: item.time }),
                            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs(
                Card,
                {
                  className: "border border-border bg-surface/90",
                  children: [
                    /* @__PURE__ */ jsx(CardHeader, { className: "flex-row items-center justify-between space-y-0 px-6 pt-6 pb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }),
                      /* @__PURE__ */ jsx(CardTitle, { className: "text-sm", children: "Proxima melhor acao" })
                    ] }) }),
                    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 px-6 pb-6 text-sm text-text-muted", children: [
                      nextCase ? /* @__PURE__ */ jsxs(
                        "div",
                        {
                          className: "rounded-2xl border border-border bg-white px-4 py-4 shadow-[0_8px_20px_rgba(18,38,63,0.06)]",
                          children: [
                            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-text", children: nextCase.title }),
                            /* @__PURE__ */ jsxs("p", { className: "text-xs text-text-subtle", children: [
                              "Cliente: ",
                              nextCase.cliente,
                              " - Area ",
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-2", children: [
                              /* @__PURE__ */ jsx(Badge, { className: cn("uppercase", slaBadgeClass(nextCase.slaRisk)), children: nextCase.slaRisk }),
                              /* @__PURE__ */ jsx(Badge, { className: cn("uppercase", stageBadgeClass(nextCase.stage)), children: nextCase.stage })
                            ] })
                          ]
                        }
                      ) : /* @__PURE__ */ jsx(
                        ...
                        {
                          className: "rounded-2xl border border-border bg-white px-4 py-4 text-xs text-text-muted shadow-[0_8px_20px_rgba(18,38,63,0.06)]",
                          children: "Nenhum caso ativo encontrado."
                        }
                      ),
                      /* @__PURE__ */ jsx("p", { className: "text-xs text-text-muted", children: "Atualize o dossie e registre as pendencias prioritarias." }),

...
export const PageState = ({ status, children, emptyTitle = 'Nada por aqui...', emptyDescription = 'Conteudos serao exibidos assim que estiverem disponiveis.', errorTitle = 'Nao foi possivel carregar', errorDescription = 'Tente novamente em alguns segundos.', onRetry, }) => {
    if (status === 'ready') {
